...
const initialFiles: FileType[] = [
  ...
  "nodes": [
    ...
    { "id": "7", "label": "Reinforcement Learning" },
    { "id": "8", "label": "Supervised Learning" },
    { "id": "9", "label": "Unsupervised Learning" },
    { "id": "10", "label": "Transformers" },
    { "id": "11", "label": "GPT Models" },
    { "id": "12", "label": "BERT" },
    { "id": "13", "label": "CNN" },
    { "id": "14", "label": "RNN" },
    { "id": "15", "label": "LSTM" },
    { "id": "16", "label": "Attention Mechanism" },
    { "id": "17", "label": "Backpropagation" },
    { "id": "18", "label": "Gradient Descent" },
    { "id": "19", "label": "Overfitting" },
    { "id": "20", "label": "Transfer Learning" }
  ],
  "edges": [
